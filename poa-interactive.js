...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#A9A9A9").s().p("AzPAlIAAhKMAmfAAAIAABKg");
...
}).prototype = getMCSymbolPrototype(lib.Symbol5a, new cjs.Rectangle(-2.5,0,246.4,7.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		var1b = "2016" //default date..these change after user inputs a new date
		var2b = "2017" //defaulte date..these change after user inputs a new date
		var startDate = new Date("10-01-" + var1); //YYYY-MM-DD
		var endDate = new Date("09-30-" + var2); //YYYY-MM-DD
		var startDate2 = new Date("10-01-" + var1b); //YYYY-MM-DD
		var endDate2 = new Date("09-30-" + var2b); //YYYY-MM-DD
		...
		root.start = function () {
			...
			stage.stageMouseMoveHandler = function (e) {
				...
				//////////////////////////////////////////////////////////////
				//console.log("sliderzz value is " + tmp + slider3.currentValue3);
				//console.log("dateArr is " + dateArr)
				root.slider.pinPoint.myDate.txt.text = dateArr2[tmp];	
			...
			stage.stageMouseMoveHandler2 = function (e) {
				...
				root.slider2.pinPoint.myDate.txt.text = dateArr2[tmp2];
		...
		this.myFunction = function (tmp) {
			...
			//pinpoint dragger dates
			//original:  this needs to stay as is for the top pinpoint
			var1 = root.txt1.text = "20" + tmp - 2;
			var2 = root.txt3.text = "20" + tmp - 1;
			
			//new:  this needs to go to a different datearr for the bottom 2 pinpoints
			var1b = root.txt1.text = "20" + tmp - 1;
			var2b = root.txt3.text = "20" + tmp - 0;
			...
			//for bottom 2 pinpoints
			startDate2 = new Date("10-01-" + var1b);
			endDate2 = new Date("09-30-" + var2b);
			
			//this stays the same for the top pinpoint
			dateArr = getDateArray(startDate, endDate);
			
			//this is new for the bottom 2 pinpoints.  
			dateArr2 = getDateArray(startDate2, endDate2);
			...
			//////PoP////////OMGGGGG
			//setting the YEAR range for the pop left side
			popVar1 = root.txt3.text = "20" + tmp - 2;
			popVar2 = root.txt3.text = "20" + tmp - 1;
		...
		function calcDate(foo) {
			...
			if (Math.round(slider3.pinPoint.x) == 248) {
				...
				root.slider3.pinPoint.t1.text = "10/1/" + (parseInt(root.txt3.text)) + " to " + "9/30/" + (parseInt(root.txt7.text) - 1);
		...
		function calcDate2(foo) {
			...
			if (Math.round(slider3.pinPoint.x) == 248) {
				...
				root.slider3.pinPoint.t2.text = "10/1/" + (parseInt(root.txt7.text) - 1) + " to " + "9/30/" + (parseInt(root.txt7.text));
			} else {
				//otherwise just update normally
				root.slider3.pinPoint.t2.text = popArr3[tmp3] + " to " + someFormattedDate;
			}
	...
	// temp_spacers
	this.instance_40 = new lib.CachedBmp_88();
	...
	this.fooNew = new lib.Symbol5a();
	this.fooNew.name = "fooNew";
	this.fooNew.setTransform(384.2,404.3);

	this.whiteCover3 = new lib.Symbol5a();
	this.whiteCover3.name = "whiteCover3";
	this.whiteCover3.setTransform(135.15,404);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.foo},{t:this.foo2},{t:this.whiteCover3},{t:this.fooNew}]}).wait(1));
	...
	this.instance_43 = new lib.CachedBmp_93();
	this.instance_43.setTransform(21.7,604.2,0.5,0.5);

	this.instance_44 = new lib.CachedBmp_92();
	this.instance_44.setTransform(11.45,563.6,0.5,0.5);

	this.instance_45 = new lib.CachedBmp_91();
	this.instance_45.setTransform(16.5,500.05,0.5,0.5);

	this.instance_46 = new lib.CachedBmp_90();
	this.instance_46.setTransform(2.55,343.35,0.5,0.5);
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/CachedBmp_96.png?1681400603588", id:"CachedBmp_96"},
		{src:"images/CachedBmp_90.png?1681400603588", id:"CachedBmp_90"},
		{src:"images/header.png?1681400603588", id:"header"},
		{src:"images/poa_interactive_atlas_1.png?1681400603525", id:"poa_interactive_atlas_1"},
		{src:"images/poa_interactive_atlas_2.png?1681400603525", id:"poa_interactive_atlas_2"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1681400603588", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1681400603588", id:"sdk/anwidget.js"},
		{src:"components/ui/src/textinput.js?1681400603588", id:"an.TextInput"}
	],
	preloads: []
};
